...
%\begin{itemize}
%\item Road cycling
%\item Alpine, Nordic, and Backcountry skiing
%item Mountaineering (Summer, and Ski)
%\item Outdoor photography – \url{www.istockphoto.com/madhadders}
%\item Whitewater rafting and Sea Kayaking
%\end{itemize}
